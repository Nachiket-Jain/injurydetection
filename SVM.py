...
# Train SVM model
model = SVC(kernel='rbf', probability=True, random_state=None, class_weight='balanced')
...
def test_model():
    ...
    input_data = np.array([[player_age, player_weight, player_height, previous_injuries, training_intensity, recovery_time]])
